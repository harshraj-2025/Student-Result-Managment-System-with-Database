...
class StudentClass:
    def __init__(self,root):
        ...
        #==title==
        title=Label(self.root,text="Manage Student Details",font=("goudy old style",20,"bold"),bg="#033054",fg="white").place(x=12,y=15,width=1180,height=35)
        #==variables=====================
...
#====column1==========================================
        ...
        txt_pin=Entry(self.root,textvariable=self.var_pin,font=("goudy old style",15,'bold'),bg='lightyellow').place(x=550,y=220,width=100)
